        ...
        <div className="max-w-md w-full bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-md border border-slate-100 dark:border-slate-800 text-center space-y-4">
          ...
          <div className="pt-2 flex gap-3 justify-center">
            ...
            <button
              ...
              className="px-4 py-2 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-350 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg text-sm font-semibold transition-all cursor-pointer"
            >
              Logout
            </button>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row gap-4 items-center justify-between">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 dark:bg-slate-800 focus:border-blue-550 focus:outline-none text-sm transition-all"
            />
          </div>
        </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider ${
                          item.role === 'admin' 
                            ? 'bg-blue-105 text-blue-700 dark:bg-blue-900/35 dark:text-blue-300 border border-blue-200 dark:border-blue-800'
                            : item.role === 'operator'
                            ? 'bg-amber-100 text-amber-700 dark:bg-amber-900/35 dark:text-amber-300 border border-amber-200 dark:border-amber-800'
                            : 'bg-slate-100 text-slate-655 dark:bg-slate-800/80 dark:text-slate-400 border border-slate-200 dark:border-slate-700'
                        }`}>
                          {item.role}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                        <div className="flex items-center justify-center gap-3">
                          <button
                            ...
                            className="inline-flex items-center justify-center px-2.5 py-1 text-xs bg-amber-50 hover:bg-amber-100 dark:bg-amber-950/20 dark:hover:bg-amber-955/40 text-amber-600 dark:text-amber-400 border border-amber-100 dark:border-amber-900/30 rounded-lg transition-colors cursor-pointer"
            ...
            <form onSubmit={handleFormSubmit} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setIsFormOpen(false)}
                  className="flex-1 py-2.5 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-750 dark:text-slate-350 text-sm font-semibold rounded-xl transition-all cursor-pointer text-center"
                >
                  Batal
                </button>
                <button
      ...
      {resetPwdResult && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm transition-all duration-300">
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-800 p-6 text-center space-y-4 transform transition-all">
            ...
            <div className="bg-amber-50/55 dark:bg-amber-950/10 border border-amber-100 dark:border-amber-900/30 p-4 rounded-xl space-y-1">
            ...
            <button
              ...
              className="w-full py-2.5 bg-slate-800 hover:bg-slate-750 text-white font-semibold text-sm rounded-xl transition-all cursor-pointer shadow-md"
            >
