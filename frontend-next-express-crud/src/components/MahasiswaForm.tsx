          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                disabled={isSubmitting}
                className="w-full px-4 py-2.5 rounded-lg border border-slate-300 dark:border-slate-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:bg-slate-850 dark:text-white text-sm focus:outline-none transition-all duration-200"
                required
              >
